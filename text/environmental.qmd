...
Daily averages in water temperature generally fell within historical ranges at the stations within the first two quarters, however, all stations experienced lower temperature in January and higher highs in Q2 (@fig-range-temp). The changes in daily averages were observed at all four stations, though more pronounced at San Sebastian and Fort Matanzas, the stations close to inlets (@fig-range-temp-2; @fig-range-temp-3).
