...
Most of the stations reported daily average dissolved oxygen values within their average ranges in the first half of the year (@fig-do); however, daily averages did fall outside average ranges periodically at all stations but most pronounced at Pellicer Creek (@fig-do-4) which had above average and below daily average range. In previous years dissolved oxygen values at Pine Island (@fig-do-pi-1) and Pellicer Creek (@fig-do-pc-1) frequently fell below the 2 mg/L hypoxia threshold but so far in 2024 there have not been any low dissolved oxygen events (@fig-do-pi-2, (@fig-do-pc-2). 

Chlorophyll *a* values were often higher than average at all stations this year, except for Fort Matanzas (@fig-chla-boxplots). 
Chlorophyll *a* values at all stations fell below state thresholds in January (@fig-chla-boxplots). Elevated chlorophyll *a* was observed at Pine Island (@fig-chla-boxplots-1) and at Pellicer Creek in Q2 (@fig-chla-boxplots-4). Annual geometric mean (AGM) chlorophyll *a* values were high and above the state threshold levels at all stations, except for Fort Matanzas  (@fig-chla-agm), (@fig-chla-agm-3). San Sebastian has had elevated AGM since 2018 (@fig-chla-agm-2); however, the AGM will likely change for all stations as more data is added throughout the year.


Pine Island was the only station in the first half of 2024 that had TN data above the state threshold. Data at Pine Island exceeded the state threshold of 0.65 mg/L in January, March, and April (@fig-tn-boxplots), (@fig-tn-boxplots-1). All four stations had missing TN data in 2024. Total Kjeldahl Nitrogen (TKN) data was higher than average at all stations in January and March  (@fig-tkn-boxplots). Lower than average values were observed at San Sebastian, Fort Matanzas, and Pellicer Creek in February (@fig-tkn-boxplots). Lower than average values were observed at all stations in February, April, and June (@fig-tkn-boxplots). Pine Island was missing TKN data for February.

Total phosphorus fell below the state threshold for all the stations in the first half of 2024 with the exception of February at Pine Island which was missing data  (@fig-tp-boxplots). Fort Matanzas experienced higher than average TP values for January -- March (@fig-tp-boxplots-3) and San Sebastian had lower than average TP values for February -- June. Relatively high levels of orthophosphate were observed at Pine Island and San Sebastian in January (@fig-tp-boxplots-1, @fig-tp-boxplots-2) and below average levels in April -- June for San Sebastian, Fort Matanzas, and Pellicer Creek (@fig-tp-boxplots-2, (@fig-tp-boxplots-3).
