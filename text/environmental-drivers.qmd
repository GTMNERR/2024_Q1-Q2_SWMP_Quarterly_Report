...
plot_wind(MET_wind_long, type = 'weekday', main = NULL, angle = 45, annotate = TRUE)
...
#| echo: false
#| fig.cap: Monthly wind speed and direction from the Pellicer Creek weather station for January - March 2024.
#| fig.subcap:
#|    - "Monthly wind speeds"
#| layout-ncol: 1
...
Predicted king tide events for quarter one of 2024 were:
...
Overall, examining monthly temperature anomalies the first part of the year January and March  were higher than "normal" (@fig-temp-anomalies). With February of this year "cooler" than normal.
